...
1. **Download the official formatter**:  
   Download `SDCardFormatterv1.0.3_Linux_x86_64.tgz`[SD Memory Card Formatter Download for Linux official link](https://www.sdcard.org/downloads/sd-memory-card-formatter-for-linux/)
